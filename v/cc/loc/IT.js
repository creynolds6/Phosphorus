AddLanguage('IT','italian',{
	...
	"Ticker (You)": [
		...
		"i ristoranti locali ti staranno forse servendo carne clonata di contrabbando? La nostra deliziosa inchiesta seguirÃ  dopo il telegiornale di stasera.",
		"fan calpestano a morte una celebritÃ  dei biscotti: era tutto un malinteso, si trattava di un clone sfuggito e scambiato per l'originale."
	],
	"Ticker (Halloween)": [
	...
	"[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.": "Sei la sola ragione dietro a tutti questi biscotti. Pensa che se fossi replicabile...probabilmente guadagneresti ancora di piÃ¹.",
	"[You business name]You": "Tu",
	"[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.": "La tua attivitÃ  non potrebbe andare meglio. L'unico vero modo per migliorarla Ã¨ migliorare sÃ© stessi e diventare l'AD migliore che ci sia.",
	"CpS": "BpS",
	...
	"Wrinklers digest <b>%1% more cookies</b>.": "I divoratori digeriscono <b>%1% di biscotti in piÃ¹</b>.",
	...
	"Wrap": "Incarta",
	"Done": "Fatto",
	"Clicking \"%1\" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.": "Facendo clic su \"%1\", si genera un codice di testo che puoi inviare agli altri. I codici regalo possono essere riscattati piÃ¹ volte da chiunque, ma scadono dopo un paio di giorni. Puoi generare un solo codice regalo all'ora. Il gioco verrÃ  salvato dopo l'invio.",
	...
	"Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.": "Dopo aver riscattato un regalo, dovrai aspettare un'ora prima di poterne riscattare un altro. Il gioco verrÃ  salvato dopo la riscossione.",
	"Box design": "Design della scatola",
	"Icon": "Icona",
	"Here's your gift code!<br>Make sure to copy it so you can share it.": "Ecco il tuo codice regalo!<br>Assicurati di copiarlo cosÃ¬ da poterlo condividere.",
	...
	"There's a note too!": "C'Ã¨ anche un biglietto!",
	"How nice!": "Che pensiero gentile!",
	"You've already sent or redeemed a gift recently.": "Hai giÃ  inviato o riscosso un regalo di recente.",
	...
	"Won't you have some cookies too?": "PerchÃ© non prendi anche tu dei biscotti?",
	...
	"Take out a loan and ascend before incurring the CpS penalty.": "Richiedi un prestito prima di subire la penalitÃ  di B/s.",
	...
	"[Upgrade name 832]Power in diversity": "Forza della diversitÃ ",
	...
	"[Upgrade name 848]The dose makes the poison": "Ãˆ la dose che fa il veleno",
	...
	"[Upgrade name 854]The more they stay the same": "PiÃ¹ non cambiano",
	...
	"[Upgrade name 857]Intellectual property theft": "Furto di proprietÃ  intellettuale",
	...
	"[Achievement name 589]No time like the present": "Non c'Ã¨ momento migliore del presente",
	"[Achievement name 590]Can we get much higher": "Possiamo arrivare molto piÃ¹ in alto",
	"[Achievement name 591]Speed's the name of the game (no it's not it's called Cookie Clicker)": "VelocitÃ  Ã¨ il nome del gioco (non Ã¨ vero, si chiama Cookie Clicker)",
	...
	"[Achievement name 596]No more room in hell": "Non c'Ã¨ piÃ¹ posto all'inferno",
	...
	"[Achievement name 601]Multiplicity": "MolteplicitÃ ",
	...
	"[Achievement name 609]Know thyself": "Conoscere sÃ© stessi",
	...
	"[Achievement name 614]Self-made": "Fatti da sÃ©",
	...
	"[Achievement name 618]And now you're even older": "E ora hai anche piÃ¹ anni",
	...
	"[Achievement name 623]The leader is good, the leader is great": "Il leader Ã¨ buono, il leader Ã¨ grande",
	"[Achievement name 624]You don't think they could've used... it couldn't have been ma-": "Non crederai che possano aver usato... Non puÃ² essere stato...",
	...
	"[Achievement name 627]Not even remotely close to Kansas anymore": "Neanche piÃ¹ lontanamente vicini al Kansas",
	...
	"[Achievement name 634]Greener on the other sides": "PiÃ¹ verde sugli altri lati",
