AddLanguage('DE','german',{
	...
	"Ticker (You)": [
		...
		"KÃ¶nnte es sein, dass lokale Restaurants dir illegales Klonfleisch servieren? Unsere kÃ¶stliche Berichterstattung folgt nach den Nachrichten von heute Abend.",
		"Geliebter Keksmagnat, der fÃ¤lschlicherweise von verrÃ¼ckten Fans zu Tode getrampelt wurde. Zum GlÃ¼ck stellte sich heraus, dass es sich um einen entkommenen Klon handelte, der mit dem Original verwechselt wurde."
	],
	"Ticker (Halloween)": [
	...
	"[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.": "Du allein bist der Grund fÃ¼r all diese Kekse. Du denkst dir, wenn es mehr von dir gÃ¤be, kÃ¶nntest du vielleicht noch mehr machen.",
	"[You business name]You": "Du",
	"[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.": "Dein Unternehmen ist so groÃŸartig, wie es nur sein kann. Die einzige MÃ¶glichkeit, es noch zu verbessern, ist, dich selbst zu verbessern - und der beste CEO zu werden, den die Welt je gesehen hat.",
	"CpS": "KpS",
	...
	"Contains more wallpapers for your background selector.": "EnthÃ¤lt mehr Hintergrundbilder fÃ¼r deine Hintergrundauswahl.",
	...
	"You may now send and receive gifts with other players through buttons in the top-right of the %1 menu.": "Du kannst jetzt Ã¼ber die SchaltflÃ¤chen oben rechts im %1-MenÃ¼ Geschenke an andere Spieler senden und empfangen.",
	...
	"Send": "Senden",
	"Redeem a gift": "Ein Geschenk einlÃ¶sen",
	"Redeem": "EinlÃ¶sen",
	"paste code...": "Code einfÃ¼gen...",
	"Wrap": "/",
	"Done": "Fertig",
	"Clicking \"%1\" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.": "Wenn du auf \"%1\" klickst, wird ein Textcode generiert, den du an andere schicken kannst. Geschenkcodes kÃ¶nnen von jedem mehrfach eingelÃ¶st werden, verfallen aber nach ein oder zwei Tagen. Du kannst nur einen Geschenkcode pro Stunde erstellen. Dein Spiel wird nach dem Versenden gespeichert.",
	"You may put between %1 and %2 cookies in the gift box.": "Du kannst zwischen %1 und %2 Kekse in die Geschenkbox legen.",
	"You can leave a note. Don't be rude!<br>Maximum %1 lines and %2 characters.": "Du kannst eine Notiz hinterlassen. Sei nicht unhÃ¶flich!<br>Maximal %1 Zeilen und %2 Zeichen.",
	"Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.": "Sobald du ein Geschenk eingelÃ¶st hast, musst du eine Stunde warten, bevor du ein weiteres einlÃ¶sen kannst. Dein Spiel wird nach dem EinlÃ¶sen gespeichert.",
	...
	"Invalid code.": "UngÃ¼ltiger Code.",
	"Gift redeemed!<br>Inside, you find:": "Geschenk eingelÃ¶st!<br>Im Inneren findest du:",
	"There's a note too!": "Es gibt auch eine Notiz!",
	"How nice!": "Wie schÃ¶n!",
	"You've already sent or redeemed a gift recently.": "Du hast kÃ¼rzlich bereits ein Geschenk verschickt oder eingelÃ¶st.",
	"Customize": "Anpassen",
	...
	"Trigger the grandmapocalypse for the first time.": "LÃ¶se die Omakalypse zum ersten Mal aus.",
	...
	"Poke a wrinkler <b>%1 times</b> without killing it.": "Pikse einen Falter<b>%1 Mal</b>, ohne ihn zu tÃ¶ten.",
	...
	"Redeem a cookie gift code from a friend (or from yourself, we don't judge).": "LÃ¶se einen Keks-Geschenkcode von einem Freund oder einer Freundin ein (oder von dir selbst, wir urteilen nicht).",
	"Shape your clones to resemble %1.": "Gestalte deine Klone so, dass sie %1 Ã¤hneln.",
	"Clone": "Klon",
	"Unlock the final building.": "Schalte das letzte GebÃ¤ude frei.",
	"Frenzy": "Rausch",
	...
	"Can't send or receive gifts again for %1.": "Du kannst keine Geschenke mehr fÃ¼r %1 senden oder empfangen.",
	...
	"[STOCK 18 NAME]%1's Bakery": "%1's BÃ¤ckerei",
	"[STOCK 18 TYPE]%1": "%1",
	...
	"[Upgrade name 827]Energized nutrients": "Energiereiche NÃ¤hrstoffe",
	...
	"[Upgrade name 835]United workforce": "Vereinigte ArbeitskrÃ¤fte",
	"[Upgrade name 836]Safety patrols": "Sicherheitspatrouillen",
	"[Upgrade name 837]Clone rights": "Klonrechte",
	"[Upgrade name 838]One big family": "Eine groÃŸe Familie",
	"[Upgrade name 839]Fine-tuned body plans": "Feinabgestimmte KÃ¶rperplÃ¤ne",
	"[Upgrade name 840]Foam-tipped canes": "StÃ¶cke mit Schaumstoffspitze",
	"[Upgrade name 841]Self-driving tractors": "Selbstfahrende Traktoren",
	"[Upgrade name 842]Mineshaft supports": "BergwerksstÃ¼tzen",
	"[Upgrade name 843]Universal automation": "Universelle Automatisierung",
	"[Upgrade name 844]The big shortcake": "Der groÃŸe MÃ¼rbeteigkuchen",
	"[Upgrade name 845]Temple traps": "Tempelfallen",
	"[Upgrade name 846]Polymorphism": "Polymorphismus",
	"[Upgrade name 847]At your doorstep in 30 minutes or your money back": "In 30 Minuten an deiner HaustÃ¼r oder du bekommst dein Geld zurÃ¼ck",
	...
	"[Upgrade name 870]Spritz cookies": "SpritzgebÃ¤ck",
	...
	"[Achievement name 590]Can we get much higher": "KÃ¶nnen wir noch viel hÃ¶her hinaus?",
	"[Achievement name 591]Speed's the name of the game (no it's not it's called Cookie Clicker)": "Die Geschwindigkeit ist der wichtigste Teil des Spiels (nein, es heiÃŸt nicht Cookie Clicker).",
	...
	"[Achievement name 596]No more room in hell": "Kein Platz mehr in der HÃ¶lle",
	...
	"[Achievement name 601]Multiplicity": "VielfÃ¤ltigkeit",
	"[Achievement name 602]Born for this job": "Geboren fÃ¼r diesen Job",
	...
	"[Achievement name 606]Overcrowding": "Ãœberbelegung",
	"[Achievement name 607]Strength in numbers": "StÃ¤rke durch QuantitÃ¤t",
	...
	"[Achievement name 618]And now you're even older": "Und jetzt bist du noch Ã¤lter",
	...
	"[Achievement name 623]The leader is good, the leader is great": "Der AnfÃ¼hrer ist gut, der AnfÃ¼hrer ist groÃŸartig",
	...
	"[Achievement name 626]Sugar, spice, and everything nice": "Zucker, GewÃ¼rze und alles, was schÃ¶n ist",
	"[Achievement name 627]Not even remotely close to Kansas anymore": "Nicht einmal mehr annÃ¤hernd so nah an Kansas",
	"[Achievement name 628]I only meant to stay a while": "Ich wollte nur eine Weile bleiben",
	"[Achievement name 629]Not 20 years away forever": "Nicht fÃ¼r immer 20 Jahre entfernt",
	...
	"[Achievement name 634]Greener on the other sides": "GrÃ¼ner auf den anderen Seiten",
	...
	"[Achievement name 638]Oft we mar what's well": "Oft stÃ¶ren wir, was gut ist",
